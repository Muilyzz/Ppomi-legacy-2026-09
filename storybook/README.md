...
`npm run storybook` — 작업대·분개·증거(OCR)·증빙 잠금·값 종류.

증빙 잠금(2026-09-12, [MZZ-81](https://linear.app/muilyzz/issue/MZZ-81) · [MZZ-73](https://linear.app/muilyzz/issue/MZZ-73) · [MZZ-70](https://linear.app/muilyzz/issue/MZZ-70)): http://localhost:6006 → 사이드바 **증빙/**. 툴바 **스타일 = 뽀미 테마**.
