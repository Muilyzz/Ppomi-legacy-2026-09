...
값 종류(Facts, [MZZ-74](https://linear.app/muilyzz/issue/MZZ-74)): 사이드바 **값 종류/**. `Facts.Panel` 은 스키마 값 종류만 보고 자식을 붙인다(표는 항상, 시간축은 time, 트리맵은 path+amount, 평면도는 place). 도메인 분기 없음.
