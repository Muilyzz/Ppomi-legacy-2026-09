...
const CACHE = 'ppomi-public-home-20260911-7';
const PUBLIC_PATHS = new Set([
  '/', '/web/vendor/tokens.css', '/web/home.css', '/web/home.js', '/web/auth.js', '/web/auth-client.js', '/web/auth-error.js', '/web/config.js', '/web/device-store.js',
