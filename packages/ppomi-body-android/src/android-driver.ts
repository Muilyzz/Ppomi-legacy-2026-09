...
/**
 * `OsUiDriver` over `android_open` / `android_screen` / `android_click` / `android_type`.
 * Does not talk to Accessibility itself and has no device-approval or payment input.
 */
export class AndroidDriver implements OsUiDriver {
  readonly kind = "os-android" as const;
...
/** @deprecated Renamed to `AndroidDriver`. */
export const AndroidAdapter = AndroidDriver;
