...
/**
 * Structural stand-in for today's `playbook-runtime` `PlaybookRuntime`.
 * Wiring / tests only. Not a product `adapter-*` package.
 */
...
/** Map ppomi-brain BodyRuntime onto current playbook-runtime without importing it. */
